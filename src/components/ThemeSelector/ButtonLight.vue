<template>
  <a href="#" @click.prevent="changeThemeMode">
    ...
    >
      ...
      <line x1="4.22" y1="4.22" x2="5.64" y2="5.64" data-v-2b778c3e=""></line>
      <line
        x1="18.36"
        y1="18.36"
        x2="19.78"
      ...
      <line x1="4.22" y1="19.78" x2="5.64" y2="18.36" data-v-2b778c3e=""></line>
      <line x1="18.36" y1="5.64" x2="19.78" y2="4.22" data-v-2b778c3e=""></line>
    </svg>
  </a>
</template>
...
export default {
  methods: {
    changeThemeMode() {
      this.$emit('changeThemeMode', 'light');
    },
  },
};
</script>
